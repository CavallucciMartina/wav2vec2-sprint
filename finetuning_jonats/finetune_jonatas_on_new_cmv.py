...
show_random_elements(common_voice_train, 4)
...
training_args = TrainingArguments(
            output_dir='./finetuning_jonatas_on_new_cmv/checkpoints',
            do_train=True,
            do_eval=True,
...
try:
    ...
    print("#### Save model")
    trainer.save_model('./finetuning_jonatas_on_new_cmv/final')
except Exception as e:
    with open('./finetuning_jonatas_on_new_cmv/error.txt', 'w') as f:
        f.write(str(e))
    print(str(e))